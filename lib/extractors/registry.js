...
import { MSNExtractor } from './msn.js'
import { CarDekhoExtractor } from './cardekho.js'
import { HindustanTimesExtractor } from './hindustantimes.js'
...
class ExtractorRegistry {
  ...
  registerDefaultExtractors() {
    ...
    this.register(new MSNExtractor())
    this.register(new CarDekhoExtractor())
    this.register(new HindustanTimesExtractor())
